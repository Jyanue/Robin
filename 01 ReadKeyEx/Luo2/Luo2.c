...
//              );
//  //lbdebug begin
//  Print(L"HandleCount: %08d\n",HandleCount);
//  //lbdebug end
//  
//  if(!EFI_ERROR (Status)){
//  	for (HandleIndex = 0; HandleIndex < HandleCount; HandleIndex++) {
//  		//lbdebug begin
//  		Print(L"1 HandleIndex: %08d\n",HandleIndex);
//  		//lbdebug end
//  	  Status = gBS->HandleProtocol (Handles[HandleIndex], &gEfiSimpleTextInputExProtocolGuid, (VOID **) &SimpleEx);
//  	 
//  	  //ASSERT_EFI_ERROR (Status);	//defined in MdePkg/include/library/DebugLib.h
//  	  if(!EFI_ERROR (Status)){
//  	  	Status = SimpleEx->ReadKeyStrokeEx(SimpleEx,&KeyData);
//  	  	//lbdebug begin
//  			Print(L"2 HandleIndex: %08d\n",HandleIndex);
//  			//lbdebug end
//  	  	if(!EFI_ERROR (Status)){
//  	  		//lbdebug begin
//  				Print(L"3 HandleIndex: %08d\n",HandleIndex);
//  				//lbdebug end
