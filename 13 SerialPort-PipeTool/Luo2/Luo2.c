...
//		else
//		{
//			Print(L"Call LocateSerialIO, Find device!\n");
//			DisplaySerialMode();
//		
//		WaitKey();
//		Print(L"Set serial port: 115200\n");
//		SetSerialPortAttrib(115200,NoParity,8,OneStopBit);
//		WaitKey();
//		DisplaySerialMode();
//		WaitKey();
//		Print(L"Send test string:\n");
//		WaitKey();
//		Status=SendDataBySerial(sizeof(lbtest)/sizeof(UINT8),lbtest);
//		if (EFI_ERROR (Status)) 
//		{
//			Print(L"Call SendDataBySerial, error!\n");
//			switch(Status)
//			{
...
//		else
//		{
//			Print(L"Call SendDataBySerial, OK!\n");
//		}
	}
