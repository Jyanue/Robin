//code by luobing 2013-3-19 11:07:59
...
//Name: GetPciConfigurationSpace
//Input:
//Output:pci=256 bytes buffer
//获取完整的pci设备的256字节配置空间
EFI_STATUS GetPciConfigurationSpace (
  IN  EFI_PCI_ROOT_BRIDGE_IO_PROTOCOL     *PciRootBridgeIo,
  OUT UINT8                          *Pci,
  IN  UINT8                               Bus,
  IN  UINT8                               Device,
  ...
  )
{
  ...
  VendorID=(((UINT16)Pci[1])<<8)  + (UINT16)Pci[0];
