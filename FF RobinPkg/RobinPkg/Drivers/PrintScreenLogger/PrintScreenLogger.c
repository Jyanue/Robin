...
#define BMP_BITS_PER_PIXEL  24
    ...
    BmpBufferSize = (UINTN)MultU64x32 ((UINT64)DataSizePerLine, Gop->Mode->Info->VerticalResolution) + sizeof(BMP_IMAGE_HEADER) + ((sizeof(BMP_IMAGE_HEADER) + 3) & ~0x03);
    ...
    Status = FileHandle->Write (FileHandle, (UINTN *)&WriteSize, BmpHeader);
    if (EFI_ERROR(Status)) {
