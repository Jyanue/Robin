  ...
  )
{
  ...
  EFI_HII_HANDLE               HiiHandle[2]; //robin add
  EFI_STRING ConfigRequestHdr; //robin add
  UINTN BufferSize; //robin add
  ...
  //robin add 2020-06-26 10:32:53  begin ==========================
  //Now do HII Stuff
  ...
  //robin add 2020-06-26 10:37:45 begin ============================
