//code by luobing 2013-3-19 10:58:03
...
{
	Print((CHAR16 *)L"Print Current Mode Message:\n");
	Print((CHAR16 *)L"::MaxMode=%02x\n",gGraphicsOutput->Mode->MaxMode);
	Print((CHAR16 *)L"::Current Mode=%02x\n",gGraphicsOutput->Mode->Mode);
	Print((CHAR16 *)L"::SizeOfInfo=%x\n",gGraphicsOutput->Mode->SizeOfInfo);
	Print((CHAR16 *)L"::Info->Version=%x\n",gGraphicsOutput->Mode->Info->Version);
	Print((CHAR16 *)L"::Info->HorizontalResolution=%x\n",gGraphicsOutput->Mode->Info->HorizontalResolution);
	Print((CHAR16 *)L"::Info->VerticalResolution=%x\n",gGraphicsOutput->Mode->Info->VerticalResolution);
	Print((CHAR16 *)L"::Info->PixelsPerScanLine=%x\n",gGraphicsOutput->Mode->Info->PixelsPerScanLine);
...
EFI_STATUS DisplaySpecifyModeMessage(UINT32 ModeNumber)
{
	...
	Print((CHAR16 *)L"Print Mode %d Message:\n",ModeNumber);
	Print((CHAR16 *)L"::Info->Version=%d\n",Info->Version);
	Print((CHAR16 *)L"::Info->HorizontalResolution=%d\n",Info->HorizontalResolution);
	Print((CHAR16 *)L"::Info->VerticalResolution=%d\n",Info->VerticalResolution);
	Print((CHAR16 *)L"::Info->PixelsPerScanLine=%d\n",Info->PixelsPerScanLine);
...
{
	Print((CHAR16 *)L"Print SimPleTextMode Message:\n");
	Print((CHAR16 *)L"::MaxMode=%d\n",gST->ConOut->Mode->MaxMode);
	Print((CHAR16 *)L"::Current Mode=%d\n",gST->ConOut->Mode->Mode);
	Print((CHAR16 *)L"::Attribute=%d\n",gST->ConOut->Mode->Attribute);
	Print((CHAR16 *)L"::CursorColumn=%d\n",gST->ConOut->Mode->CursorColumn);
	Print((CHAR16 *)L"::CursorRow=%d\n",gST->ConOut->Mode->CursorRow);
	Print((CHAR16 *)L"::CursorVisible=%d\n",gST->ConOut->Mode->CursorVisible);
...
EFI_STATUS DisplaySpecifyTextModeMessage(UINTN ModeNumber)
{
	...
	Print((CHAR16 *)L"Print Text Mode %d Message:\n",ModeNumber);
	Print((CHAR16 *)L"::Column=%d\n",Columns);
	Print((CHAR16 *)L"::Row=%d\n",Rows);
